...
function arrayReverse(arr) {
    var longitudDelArr = arr.length;
    for (var i = 0; i < longitudDelArr / 2; i++) { //recorremos array hasta la mitad
        // guardo el valor actual
        var temporal = arr[i];
        // Calcular el índice contrario, es decir, el del otro lado de la mitad; el cual irá descendiendo
        var indiceContrario = longitudDelArr - i - 1;
...
/******************************************************************************* */
//7.- 
function filterItems(arr, element) {
